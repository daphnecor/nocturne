...
TRAIN_DATA_PATH = DATA_FOLDER / 'training'
VALID_DATA_PATH = DATA_FOLDER / 'validation'
TEST_DATA_PATH = DATA_FOLDER / 'testing'
PROCESSED_TRAIN_NO_TL = DATA_FOLDER / f'formatted_json_v{VERSION_NUMBER}_no_tl_train'
PROCESSED_VALID_NO_TL = DATA_FOLDER / f'formatted_json_v{VERSION_NUMBER}_no_tl_valid'
PROCESSED_TRAIN = DATA_FOLDER / f'formatted_json_v{VERSION_NUMBER}_train'
PROCESSED_VALID = DATA_FOLDER / f'formatted_json_v{VERSION_NUMBER}_valid'
ERR_VAL = -1e4
